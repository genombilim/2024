---
title: "5700 yıllık antik sakız verisi analizi "
...
Bu proje kapsamında temel amaçlar: 

1. Antik sakız verisinde bulunan mikrobiyal içeriğin incelenmesi
2. Bu mikrobiyal içerik içerisinde bulunana *Streptococcus pneumoniae* bakterisine ait olan okumaların alınması ve otanikasyonu

Hedefler:

1. Antik sakız verilerinin indirilmesi
2. `Kraken2` aracı ile mikrobiyal içeriğinde belirlenmesi
3. `R` ve `ggplot2` ile, örnek içindeki mikrobiyal türlerin yoğunluklarının gösterilmesi
4. *Streptococcus pneumoniae* bakterisine ait olan okumaların eldesi
5. *Streptococcus pneumoniae* bakterisinin referans genomunun indirilmesi 
6. Okumaların hizalamması ve `bam` dosyalarının elde edilmesi
7. `mapDamage2` programı ile okumaların sahip oldukların deaminasyon profillerinin gösterilmesi 
